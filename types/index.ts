...
export interface HindiMapping extends BaseEntity {
  ...
  altHindiName3?: string;
  altHindiName4?: string;
  altEnglishName1?: string;
  altEnglishName2?: string;
  altEnglishName3?: string;
  altEnglishName4?: string;
  altHindiDescription1?: string;
  altHindiDescription2?: string;
  altEnglishDescription1?: string;
  altEnglishDescription2?: string;
  type: 'item' | 'vendor';
  usageCount: number;
  isAutoGenerated: boolean;
}
